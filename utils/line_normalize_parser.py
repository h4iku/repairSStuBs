...
def check_line_javaparser(src_file: Path, line_number: int):
    """Extracting the complete bug line when it is expanded on multiple lines or
    the line number in the dataset is pointing to somewhere else like comments
    before reaching the actual line using JavaParser.
    """
    pass
